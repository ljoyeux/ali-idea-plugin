...
public class SimpleEditor extends JFrame {
    ...
    protected void makeActionsPretty() {
        ...
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/cut.gif"));
        a.putValue(Action.NAME, "Cut");

        a = textComp.getActionMap().get(DefaultEditorKit.copyAction);
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/copy.gif"));
        a.putValue(Action.NAME, "Copy");

        a = textComp.getActionMap().get(DefaultEditorKit.pasteAction);
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/paste.gif"));
    ...
    class OpenAction extends AbstractAction {
        public OpenAction() {
            super("Open", HTMLUtils.load("icons/open.gif"));
        }
    ...
    class SaveAction extends AbstractAction {
        public SaveAction() {
            super("Save", HTMLUtils.load("icons/save.gif"));
        }
