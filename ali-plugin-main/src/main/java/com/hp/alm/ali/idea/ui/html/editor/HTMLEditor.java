...
public class HTMLEditor extends StyledEditor {
    ...
    protected void makeActionsPretty() {
        ...
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/hr.gif"));
        ...
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/copyright.gif"));
        ...
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/link.gif"));
        ...
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/anchor.gif"));
        a.putValue(Action.NAME, "Anchor Name");
        getTextComponent().getActionMap().put("anchor-name", a);

        a = new ImageAction();
        a.putValue(Action.SMALL_ICON, HTMLUtils.load("icons/picture.gif"));
